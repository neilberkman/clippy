...
func TestPastyWithTextClipboard(t *testing.T) {
	...
	clippyCmd := exec.Command("./clippy_test", "--verbose", "--cleanup=false")
...
func TestPastyToFile(t *testing.T) {
	...
	clippyCmd := exec.Command("./clippy_test", "-v", "--cleanup=false")
...
func TestPastyWithFileClipboard(t *testing.T) {
	...
	clippyCmd := exec.Command("./clippy_test", "-v", "--cleanup=false", testFile)
	clippyOutput, err := clippyCmd.CombinedOutput()
	if err != nil {
